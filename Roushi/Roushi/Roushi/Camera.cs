...
// Credit Given To: Khalid Abuhakmeh
// Need to re-write sometime
...
namespace Roushi
{
    ...
    public class Camera2D : GameComponent, ICamera2D
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _position.X += (Focus.Get<TransformPart>().GetPositionX - Position.X) * MoveSpeed * delta;
            _position.Y += (Focus.Get<TransformPart>().GetPositionY - Position.Y) * MoveSpeed * delta;
